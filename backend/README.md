...
| `design_style` | string | No | `"minimal"` | `"minimal"`, `"gradient"`, `"neon"`, `"pastel"`, `"glass"`, `"retro"` |
| `theme` | string | No | `"light"` | `"light"`, `"dark"` |
| `aspect_ratio` | string | No | `"1179x2556"` | See table below |
...
| Style | Description |
|-------|-------------|
| `minimal` | Clean, professional, paper-like |
